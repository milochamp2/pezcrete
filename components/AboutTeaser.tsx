        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div>
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(2.75rem,8vw,6rem)", color: "var(--black)" }}
            >
              PRECISION.
              <br />
            ...
            <div className="mt-10 reveal reveal-delay-3">
              <Link href="/about" className="btn-dark w-full sm:w-auto text-center sm:text-left">
          ...
          <div className="flex flex-col reveal reveal-delay-2">
            {stats.map((s) => (
              <div key={s.label} className="py-6 sm:py-8 border-b first:border-t" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
                <div className="flex items-center gap-5 sm:gap-6">
                  ...
                  <p className="text-sm sm:text-base tracking-widest uppercase" style={{ color: "var(--text-on-light-muted)" }}>
                    {s.label}
                  </p>
                </div>
              </div>
